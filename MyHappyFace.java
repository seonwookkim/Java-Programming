...
public class MyHappyFace extends Application {
	...
	public static final int MOUTH_HEGHIT = 50 ;
	...
	public void start (Stage primaryStage) throws Exception{
		...
		gc.setFill(Color.BLACK) ;
		gc.strokeOval(X_RIGHT_EYE, Y_RIGHT_EYE, EYE_WIDTH, EYE_HEIGHT) ;
		gc.setFill(Color.BLUE) ;
		gc.fillOval(X_LEFT_EYE, Y_LEFT_EYE, EYE_WIDTH, EYE_HEIGHT) ;
		gc.setFill(Color.BLACK) ;
		gc.strokeOval(X_LEFT_EYE, Y_LEFT_EYE, EYE_WIDTH, EYE_HEIGHT) ;
		
		gc.setFill(Color.BLACK) ;
		gc.fillOval(X_NOSE, Y_NOSE, NOSE_DIAMETER, NOSE_DIAMETER) ;
		
		gc.setFill(Color.RED) ;
		gc.fillArc(X_MOUTH, Y_MOUTH, MOUTH_WIDTH, MOUTH_HEGHIT, MOUTH_START_ANGLE, MOUTH_DEGREES_SHOWN, ArcType.CHORD) ;
